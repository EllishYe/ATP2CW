...
namespace ScratchCardAsset.Core.ScratchData
{
    public class Triangle
    {
        ...
        {
            SetData(vertex0, vertex1, vertex2, uv0, uv1, uv2);
        }

        public void SetData(Vector3 vertex0, Vector3 vertex1, Vector3 vertex2, Vector2 uv0, Vector2 uv1, Vector2 uv2)
        {
            v0 = vertex0;
            v1 = vertex1;
            v2 = vertex2;
        ...
        public Vector2 GetUV(Vector3 point)
        {
            ...
            // Calculate barycentrics with sign
